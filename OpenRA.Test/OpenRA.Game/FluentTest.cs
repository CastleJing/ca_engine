...
";
		...
		public void TestOne()
		{
			...
			var label = bundle.GetMessage("Game-ObserverShroudSelectorLogic-Players", new object[] { "player", 1 });
			Assert.That("One player", Is.EqualTo(label));
			label = bundle.GetMessage("Game-ObserverShroudSelectorLogic-Players", new object[] { "player", 2 });
