...
namespace OpenRA.Mods.Common.Widgets
{
	public class ButtonWidget : InputWidget
	{
		...
		public ButtonWidget(ModData modData)
		{
			...
			var textCache = new CachedTransform<string, string>(s => !string.IsNullOrEmpty(s) ? Game.Translate(s) : "");
			var tooltipTextCache = new CachedTransform<string, string>(s => !string.IsNullOrEmpty(s) ? Game.Translate(s) : "");
			var tooltipDescCache = new CachedTransform<string, string>(s => !string.IsNullOrEmpty(s) ? Game.Translate(s) : "");
